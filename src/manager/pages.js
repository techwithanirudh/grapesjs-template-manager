        ...
        (page, i) => `<div 
            ...
            >
                ...
                ${
                  isSelected(page)
                    ? ""
                    : `<span class="page-close" data-key="${page.id}">&Cross;</span>`
                }
      ...
      this.state.isShowing ? "flex" : "none"
                ...
                <div  class="flex-row">
                    <input 
                        class="tm-input sm" 
                        type="text" 
                        placeholder="${editor.I18n.t(
                          "grapesjs-project-manager.pages.placeholder"
                        )}" 
                    />
                </div>
                <div class="add-page">
